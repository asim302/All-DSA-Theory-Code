...
/*
// Age se  ye Traversing aise krni ha
node *last_node = head;

while (last_node->adress != nullptr) // jab tk node ke andr pare agle node ka adress null na ajaye tab tk traversing kro
{
    last_node = last_node->adress;
    // aur jhan par agla node ka adress null agya whi last wala node ha
    // us ke age agla node jor do
}

node *newNode = new node;
newNode->data = a;
newNode->adress = nullptr;
// Ab last_node ko newnode ke sath jor do
last_node->adress = newNode;
